...
{
    public class RegisterUserCommanHandler(UserManager<AppUser> userManager, IMapper mapper) : IRequestHandler<RegisterUserCommand, ServiceResult<Guid>>
    {
        public async Task<ServiceResult<Guid>> Handle(RegisterUserCommand request, CancellationToken cancellationToken)
        {
